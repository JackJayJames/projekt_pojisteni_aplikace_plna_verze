...
const adresy = {
    ...
    password: new FormInputOutput(document.querySelector('#poj_password'), document.querySelector('#er-Password'), Validace.zvalidovatPassword),
    ...
    mail: new FormInputOutput(document.querySelector('#poj_email'), document.querySelector('#er-Email'), Validace.zvalidovatEmail),
